        ...
        >
         <h1 className="text-2xl sm:text-3xl font-bold mb-4 text-green-700">
          ...
          <p className="mb-6 text-gray-600">
            Help others discover GigPesa and earn rewards! Our referral program
            is designed to thank you for spreading the word.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li>
              When someone signs up using your link and starts earning, you get
              a bonus.
            </li>
            <li>
              Earn a percentage of their earnings (without affecting theirs).
            </li>
          </ul>

          <SectionTitle>Referral Rewards</SectionTitle>
          <p className="mb-4">
            You’ll receive <strong>10% of your referral’s earnings</strong> for
            the first 3 months — automatically credited to your account.
          </p>
          ...
          <div className="mb-6">
            <input
              type="text"
              value="https://gigpesa.com/ref/yourusername"
              readOnly
              className="w-full sm:w-3/4 px-3 py-2 border border-gray-300 rounded mb-2 text-[13px]"
            />
            <button
              onClick={() => {
                navigator.clipboard.writeText("https://gigpesa.com/ref/yourusername");
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li>
              Include your referral link in your blog, videos, or bio section.
            </li>
          </ul>

          <SectionTitle>Need Help?</SectionTitle>
          <p>
            If you have questions about how referrals work,{" "}
            <a
